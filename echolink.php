...
<?php echo ("<title>Echolink for " . $CALLSIGN ." </title>"); ?>
...
<?php
    ...
    echo '<p style="margin-bottom:10px;margin-top:4px;"><a target=_blank href=echolinksvx><span style="font-family: Oswald, sans-serif;font-size:14pt;color: #0000ff;">EchoLink Log</span></a></p>';
    echo '<div style="height:580px; margin-left: 20px;">'."\n";

...
<?php
    ...
    .btn-echolink{
        ...
        color:#ffffff;
        border-radius:10px;
        background:linear-gradient(to bottom,#045fb4,#3083b8);
        padding:10px;
        margin-right:40px;
    ...
    <p style="margin-bottom:10px;margin-top:4px;"><a target="_blank" href="echolinksvx"><span class="btn-echolink">EchoLink Log</span></a></p>';
